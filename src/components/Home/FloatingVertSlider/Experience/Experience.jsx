...
const ExperienceCard = ({ experience }) => {
  return (
    <VerticalTimelineElement
      contentStyle={{
        background: 'rgba(29, 24, 54, 0.7)', // Add some transparency to the background color
        color: '#fff',
      ...
      }} // Add glassmorphism to the icon as well
      icon={
...
const Experience = () => {
  return (
    <>
      ...
      <div className="mt-20 flex flex-col p-0 adjust-date">
        <VerticalTimeline>
